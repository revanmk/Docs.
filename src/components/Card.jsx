...
const Card = ({ data,reference }) => {
  ...
  return (
    <motion.div drag dragConstraints={reference} whileDrag={{scale:1.3}} className='relative h-72 w-60 bg-zinc-900/90 rounded-[40px] text-white px-8 py-10 overflow-hidden flex flex-col justify-between'>
